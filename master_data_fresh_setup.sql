-- Fresh Master Data Setup SQL
-- ⚠️  WARNING: This script is ONLY for clean/empty databases! ⚠️
-- DO NOT run this on databases with existing master data - it will cause duplicate key errors
-- For existing databases with data, use master_data_migration.sql instead
-- This script is designed for initial database setup only
